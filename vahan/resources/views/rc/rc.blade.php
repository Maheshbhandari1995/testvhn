...
<script>
    $(document).ready(function() { 
        ...
        //         // Define the regular expression pattern for the vehicle number format
        //         var vehicleNumberRegex = /^[A-Z]{2}\d{2}[A-Z]{2}\d{4}$/;
                
        //         // Test if the provided vehicle number matches the pattern
        //         var isValid = vehicleNumberRegex.test(vehicleNumber);
                
        //         // Return true if the vehicle number is valid, otherwise return false
        //         return isValid;
        //     }
